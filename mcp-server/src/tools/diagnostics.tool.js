...
function registerDiagnosticsTools(server) {
    ...
    server.tool("get_diagnostics", "Retrieve diagnostics information for a customer's ONT/router using the service ID.", {
        serviceId: zod_1.z.string().describe("Customer service ID"),
    }, function (_a) { return __awaiter(_this, [_a], void 0, function (_b) {
        var diagnostics;
        var serviceId = _b.serviceId;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0: return [4 /*yield*/, (0, api_js_1.getDiagnostics)(serviceId)];
                case 1:
                    diagnostics = _c.sent();
                    return [2 /*return*/, {
                            content: [
    ...
    server.tool("reboot_device", "Remotely reboot the customer's ONT/router. This should only be used after the customer confirms.", {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0: return [4 /*yield*/, (0, api_js_1.rebootDevice)(serviceId)];
                case 1:
                    result = _c.sent();
                    return [2 /*return*/, {
                            content: [
