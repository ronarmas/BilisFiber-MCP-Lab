...
function registerTicketTools(server) {
    ...
    server.tool("get_tickets_by_account", "Retrieve all tickets for a customer account.", {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0: return [4 /*yield*/, (0, api_js_1.getTicketsByAccount)(accountNumber)];
                case 1:
                    tickets = _c.sent();
                    return [2 /*return*/, {
                            content: [
    ...
    server.tool("get_ticket_by_id", "Retrieve a ticket by ticket ID.", {
        ...
        var ticket;
        var ticketId = _b.ticketId;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0: return [4 /*yield*/, (0, api_js_1.getTicketById)(ticketId)];
                case 1:
                    ticket = _c.sent();
                    return [2 /*return*/, {
                            content: [
    ...
    server.tool("create_ticket", "Create a new support ticket.", {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, api_js_1.createTicket)(args)];
                case 1:
                    ticket = _a.sent();
                    return [2 /*return*/, {
                            content: [
